package au.edu.federation.itech3107.studentattendance30395746.view;
...
import au.edu.federation.itech3107.studentattendance30395746.kecheng.CourseAncestor;
...
public class CourseView extends FrameLayout {
    ...
    /** The width of the row item is automatically distributed evenly according to the total width of the view. */
    ...
    /** Show Vertical Split Line */
    private boolean mShowVerticalLine = false;

    /** Show Horizontal Split Line */
    ...
    /** Add all the data in the array to the interface */
    private void initCourseItemView() {
        removeAllViews();
        l("Call initCourseItemView");
    ...
    /** Adding data after the interface has been initialised */
    ...
    private void addTagCourseView(int x, int y) {
        ...
        /*Find the coordinates of the clicked box*/
    ...
    private void itemEvent(final CourseAncestor course, final ViewGroup viewGroup, TextView textView) {
        ...
        /*Finds overlapping items within the clicked item's range*/
    ...
    /**
     * Converts sp values to px values, ensuring that the text size remains the same
     */
