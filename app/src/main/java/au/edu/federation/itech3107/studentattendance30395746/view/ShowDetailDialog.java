...
import au.edu.federation.itech3107.studentattendance30395746.kecheng.TjCourseActivity;
...
//      tvClassroom.setText(course.getCouLocation());
   ...
   private void edit(Activity activity, CourseV2 course) {
      Intent intent = new Intent(activity, TjCourseActivity.class);
      intent.putExtra(CjData.INTENT_EDIT_COURSE, course);
